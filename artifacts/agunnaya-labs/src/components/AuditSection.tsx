...
const MOCK_ENTRIES: AuditEntry[] = [
  ...
  { id:4, severity:'LOW', detector:'Selfdestruct Usage', repo:AUDIT_REPO, desc:'Contract uses selfdestruct(). Post-EIP-6049, this pattern is deprecated and may behave unexpectedly in future hard forks.', time:'1h ago', pr:'PR #139' },
  ...
  { id:6, severity:'CRITICAL', detector:'Honeypot Pattern', repo:AUDIT_REPO, desc:'Transfer restrictions detected that prevent selling. Classic honeypot mechanic — buyers cannot exit position.', time:'3h ago', pr:'PR #137' },
    ...
    <section id="audits" className="z">
      ...
      <div className="audit-terminal reveal">
        ...
        <div className="audit-stats">
          ...
          <div className="audit-stat"><div className="audit-stat-n" style={{ color:'var(--red)' }}>{loading ? '···' : stats.critical}</div><div className="audit-stat-l">Critical Found</div></div>
          <div className="audit-stat"><div className="audit-stat-n" style={{ color:'var(--orange)' }}>{loading ? '···' : stats.high}</div><div className="audit-stat-l">High Severity</div></div>
